...
use KiloShare\Controllers\DeliveryCodeController;
    ...
    $app->group('/api', function (RouteCollectorProxy $group) {
        ...
        $group->group('/v1', function (RouteCollectorProxy $v1Group) {
            ...
            $v1Group->group('/bookings', function (RouteCollectorProxy $bookingGroup) {
                ...
                // Routes de codes de livraison
                $bookingGroup->post('/{id}/delivery-code/generate', [DeliveryCodeController::class, 'generateDeliveryCode']);
                $bookingGroup->post('/{id}/delivery-code/validate', [DeliveryCodeController::class, 'validateDeliveryCode']);
                $bookingGroup->post('/{id}/delivery-code/regenerate', [DeliveryCodeController::class, 'regenerateDeliveryCode']);
                $bookingGroup->get('/{id}/delivery-code', [DeliveryCodeController::class, 'getDeliveryCode']);
                $bookingGroup->get('/{id}/delivery-code/attempts', [DeliveryCodeController::class, 'getDeliveryCodeAttempts']);
                $bookingGroup->get('/{id}/delivery-code/required', [DeliveryCodeController::class, 'checkDeliveryCodeRequired']);
