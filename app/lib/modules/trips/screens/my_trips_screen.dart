...
class _MyTripsScreenState extends State<MyTripsScreen>
  ...
  void _onTabChanged() {
    ...
    // Charger les données de l'onglet actuel en forçant l'appel API
    switch (tabIndex) {
      case 0:
        _stateManager.loadTripsData(force: true);
        break;
      case 1:
        _stateManager.loadDraftsData(force: true);
        break;
      case 2:
        _stateManager.loadFavoritesData(force: true);
        break;
    }
  }
