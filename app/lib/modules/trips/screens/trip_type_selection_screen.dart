...
import '../widgets/trip_rules_confirmation_dialog.dart';

class TripTypeSelectionScreen extends StatefulWidget {
  const TripTypeSelectionScreen({super.key});

  @override
  State<TripTypeSelectionScreen> createState() => _TripTypeSelectionScreenState();
}

class _TripTypeSelectionScreenState extends State<TripTypeSelectionScreen> {
  bool _rulesAccepted = false;

  @override
  void initState() {
    super.initState();
    // Afficher la fenêtre de règles au démarrage
  ...
  void _showInitialRulesDialog() {
    showDialog(
      ...
      builder: (context) => TripRulesConfirmationDialog(
        onConfirmed: () {
          setState(() {
            _rulesAccepted = true;
          });
