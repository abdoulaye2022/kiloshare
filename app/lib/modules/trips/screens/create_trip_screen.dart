...
import '../widgets/trip_rules_simple_confirmation_dialog.dart';
...
class _CreateTripScreenState extends State<CreateTripScreen> {
  ...
  void _nextStep() {
    ...
    if (_currentStep < _totalSteps - 1) {
      ...
      print('Last step reached, showing rules confirmation');
      _showRulesConfirmation();
    }
  }
  ...
  void _showRulesConfirmation() {
    showDialog(
      context: context,
      barrierDismissible: false,
      builder: (context) => TripRulesSimpleConfirmationDialog(
        onConfirmed: () {
          _submitTrip();
        },
      ),
